(function() {
    ...
    function resize() {
        ...
        const rows = Math.floor(VIEW_H / CELL);
    ...
    if (sim === 'life') {
        ...
        function draw() {
            ...
            for (let y = 0; y < rows; y++) for (let x = 0; x < cols; x++) {
                ...
                if (x === start.x && y === start.y) c = '#ecdcad';
                else if (x === end.x && y === end.y) c = '#f6edd0';
                else if (pathCells.has(ky)) c = '#c5a059';
                else if (grid[ky] === 1) c = '#0a2e22';
                else if (closedSet.has(ky)) c = '#2c1551';
                else if (openSet.some(n => k(n.x, n.y) === ky)) c = '#150a28';
        ...
        function draw() {
            ...
            for (let i = 0; i < arr.length; i++) {
                ...
                let color = '#c5a059';
                if (highlight.sorted.has(i)) color = '#1c6e4f';
                if (highlight.compare.includes(i)) color = '#f6edd0';
                if (highlight.swap.includes(i)) color = '#8458bd';
                ctx.fillStyle = color;
